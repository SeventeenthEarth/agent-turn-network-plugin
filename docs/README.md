...
This directory is the source of truth for the **Python Hermes plugin adapter** for Agent Turn Network (ATN). Public docs now use the ATN repo/tool/skill labels, while ATN-005 still owns the checked-in package/import/manifest/tool/skill rename.
